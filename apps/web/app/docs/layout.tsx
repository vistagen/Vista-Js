...
export default function DocsLayout({ children }: DocsLayoutProps) {
  ...
  return (
    <main className="min-h-screen bg-black text-zinc-100 selection:bg-primary/20 selection:text-primary pt-20 pb-20">
      <div className="sticky top-16 z-40 mx-auto flex w-full max-w-[1400px] justify-end gap-2 border-b border-zinc-900/70 bg-black/95 px-4 py-2 backdrop-blur sm:px-6 lg:hidden">
        <TableOfContents mode="mobile-trigger" />
        <MobileNavigation navigation={navigation} />
      </div>

      <div className="mx-auto mt-2 w-full max-w-[1400px] min-h-[calc(100vh-9rem)]">
