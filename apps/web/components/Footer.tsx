    ...
    return (
        <footer className="w-full bg-black">
            ...
            <div className="w-full flex items-center justify-center overflow-hidden h-[200px] md:h-[300px]">
                <div className="opacity-100">
                    <img
                        ...
                        width={500}
                        height={500}
                        className="invert object-contain max-w-[80vw] md:max-w-none"
                    />
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 w-full pb-8">
                <div className="w-full border-t border-dashed border-zinc-800 mb-8" />

                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                    <div className="text-sm text-zinc-600 font-medium tracking-tight">
